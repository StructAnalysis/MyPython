##بار ۱۰۰ تایی تست
##عدم بارگذاری کلیه طبقات (افزایش اعضای سازه) 
##تست intended درست


##// -----
#ریختن مش اولیه در آرایه سه بعدی
#ریختن استرس در ارایه سه بعدی
#تعریف تابع برای استرس  
#سرچ format مناسب برای آرایه چند بعدی، for، if
#-------------------------------------
#اسکریپت:
#👈ورود مش توسط pynite
...
##ا floor باید distinct شده و مقدار متناظر مختصات z بگیرد.
##عدد طبقه floor
##Reset mesh
##اif بعد سوم مساوی اندازه z
##Append mesh x,y
...
#       خواندن مش دو بعدی -ج-
#       👈 خوراندن مش به pymesh جهت مش سازی
#"demo.py"
#------------------------------------------
...
#         *** ب- یافتن نقاط مش جدید منطبق بر مش قدیم و خوراندن استرس به آرایه استرس سه بعدی search in library, یا الگوریتم جدید
#-----افزودن استرس به -ک- در نقاط مش قدیم با الگوریتم جهت شناخت مرز مش قدیم 
#-----راه حل ساده:
#-----هر نقطه مش قدیم حتما نقطه ای را در مش جدید دارد که باید استرس آن را بگیرد. منتها دیگر استرس نقطه ای می شود و نه  طیف نیرو سطح بارگیر.
#       👈  خوراندن مش به FEM  جهت استرس
###For هر نقطه مش ثانویه For هر نقطه مش اولیه
###if نقطه مش ثانویه دوبعدی و مختصات هر طبقه مساوی مش اولیه
###افزودن استرس
#for floor
...
#پایان حلقه
#end for
#👈افزودن استرس سه بعدی -ب- به ادامه pynite
...
#-----------------------------------
#***طراحی:ارسال نتایج به اکسل (کد پایتون) و اجرای ماکروها (ویا نوشتن ماکرو در پایتون) و اخذ مقطع ها
